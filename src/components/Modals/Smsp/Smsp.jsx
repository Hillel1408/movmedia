              ...
              <ul className={styles.subList}>
                ...
                <li>
                  <p className="icon-polygon">
                    ...
                    учитываемых в расчете в силу по п. 7 Положения № 1352.
                  </p>
                </li>
                <li>
                  <p className="icon-polygon">
              ...
              <ul className={styles.subList}>
                ...
                <li>
                  <p className="icon-polygon">
                    ...
                    исключаются закупки товаров, работ, услуг по п. 7 Положения
                    № 1352.
                  </p>
                </li>
                <li>
                    ...
                    >
                      ...
                      <li>
                        <p className="icon-polygon">
                          ...
                          запланированного общего объема (п. 5.3 Положения №
                          1352).
                        </p>
                      </li>
                      <li>
                        <p className="icon-polygon">
                          ...
                          объему за предыдущий год, увеличенному на 10% (п. 2
                          Положения, утв. Постановлением № 1442), а также у
                          СМСП, равный объему за предыдущий год, увеличенному на
                          5% (п. 5.2 Положения № 1352).
                        </p>
                      </li>
                      <li>
                        <p className="icon-polygon">
              ...
              <ul className={styles.subList}>
                <li>
                  <p className="icon-polygon">
                    ...
                    содержанию и форма годового отчета утверждены Постановлением
                    № 1352).
                  </p>
                </li>
                <li>
