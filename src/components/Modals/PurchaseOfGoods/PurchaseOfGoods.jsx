      ...
      items: [
        {
          idx: '01',
          title:
            'Определите планируемый общий стоимостной объем закупок товаров. Сделать это можно по кодам и наименованиям  приложенном к Постановлению № 2013 перечне.',
          list: [
    ...
    >
      <div className={styles.root}>
        ...
        <p className="text-s">
          ...
          российского происхождения предусмотрены Постановлением Правительства
          Российской Федерации от 03.12.2020 № 2013 «О минимальной доле закупок
