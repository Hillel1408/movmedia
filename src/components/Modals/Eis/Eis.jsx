...
export default function Eis() {
  ...
  const list = [
    ...
    'Сведения о договорах и их исполнении',
    'Перечень ВЗЛ',
    'Отчетность'
  ]
  const steps = [
    {
      ...
      list: {
        items: [
          'определите ответственных лиц для работы в ЕИС;',
          'примите приказ о наделении их нужными полномочиями.'
        ],
        dots: true
      }
    },
    {
      title:
        'Получите квалифицированную электронную подпись (КЭП) на генерального директора и ответственных лиц.',
      text: 'Для этого:',
      list: {
        items: [
    ...
    },
    {
      ...
      list: {
        items: [
          'зарегистрируйте организацию в ЕИС;',
          'зарегистрируйте работников в ЕИС и настройте их права.'
        ],
        dots: true
      }
    },
    {
      title:
        'Организуйте рабочее место ответственного сотрудника для работы в ЕИС.',
      button: 'Инструкция ',
      list: {
        items: [
      ...
      >
        <div className={styles.root}>
          ...
          <div className={classNames(styles.text, globalStyles.textS)}>
            ...
            <p>
              Важно начать процесс регистрации в ЕИС параллельно с процессом
              разработки решения о присоединении к Положению/принятии
          ...
          <div className={styles.grid}>
            ...
            <div className={globalStyles.textS}>
              ...
              <p>
                <span>Кто регистрирует:</span>заказчики регистрируют себя
                самостоятельно.
              </p>
            </div>
          </div>
